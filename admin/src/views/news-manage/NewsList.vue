...
// import { getNewsList_author, putNewsPublish_id, deleteNewsList_id } from '@/api/index'
...
const getTableData = async () => {
  ...
  // const res = await getNewsList_author(store.state.userInfo)
